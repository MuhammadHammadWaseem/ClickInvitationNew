		...
		<tr>
			<td>
				<table width="595"  align="center" style="background:white; text-align:center; border-radius:20px;">
					<tr>
						<td><img moz-do-not-send="false" src="https://clickinvitation.com//assets/images/logo/logoNewGolden.png" alt="VivoQui" height="42"></td>
				...
				<table width="595"  cellpadding="20"  style="background:white;font-size:16px; color:#222; font-family: Calibri, arial, sans-serif !important; " >
					<tr>
						<td>Congratulations!<br>
							...
							<a href="https://clickinvitation.com/confirm/{{$confirmation_code}}">https://clickinvitation.com/confirm/{{$confirmation_code}}</a>
